            ...
            <aside class="space-y-6">
                <div class="rounded-2xl border border-zinc-200 p-6">
                    ...
                    <div class="mt-4 space-y-2">
                        <a href="tel:0622373308" class="block text-zinc-900 font-medium hover:underline">06 22 37 33
                            08</a>
                        <a href="mailto:info@autohorsthuis.nl" class="block text-zinc-900 font-medium hover:underline">info@autohorsthuis.nl</a>
                        <a target="_blank" rel="noopener"
                           href="https://www.google.com/maps/place/Auto+Horsthuis/@52.3008493,6.9251908,16z"
                           class="inline-flex items-center gap-2 text-amber-600 hover:underline">
                            Route / Google Maps
                            <svg class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                <path
                                    d="M12.293 4.293a1 1 0 011.414 0L18 8.586l-4.293 4.293a1 1 0 01-1.414-1.414L14.586 10H4a1 1 0 110-2h10.586l-2.293-2.293a1 1 0 010-1.414z"/>
                            </svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="rounded-2xl border border-zinc-200 p-6">
                    ...
                    <ul class="mt-3 text-sm divide-y divide-zinc-200 rounded-lg overflow-hidden border border-zinc-200">
                        <li class="flex items-center justify-between bg-zinc-50 px-4 py-2"><span>Maandag</span><span>09:00–23:00</span>
                        </li>
                        <li class="flex items-center justify-between px-4 py-2">
                            <span>Dinsdag</span><span>09:00–23:00</span></li>
                        <li class="flex items-center justify-between bg-zinc-50 px-4 py-2"><span>Woensdag</span><span>09:00–17:00</span>
                        </li>
                        <li class="flex items-center justify-between px-4 py-2">
                            <span>Donderdag</span><span>09:00–17:00</span></li>
                        <li class="flex items-center justify-between bg-zinc-50 px-4 py-2"><span>Vrijdag</span><span>09:00–17:00</span>
                        </li>
                        <li class="flex items-center justify-between px-4 py-2">
                            <span>Zaterdag</span><span>08:00–17:00</span></li>
                        <li class="flex items-center justify-between bg-zinc-50 px-4 py-2"><span>Zondag</span><span>Gesloten</span>
                        </li>
                    </ul>
            ...
            <div class="rounded-2xl border border-amber-200 bg-amber-50 p-6 lg:p-8 space-y-6 h-full">
                <div>
                    ...
                    <p class="mt-3 text-zinc-800">
                        ...
                        Bel ons gerust of kom langs bij onze werkplaats in Oldenzaal. Wij helpen u snel, eerlijk en
                        vakkundig verder.
                    </p>
                    <div class="mt-6 flex flex-wrap items-center gap-3">
                        <a href="tel:0622373308"
                           class="rounded-xl px-5 py-3 font-semibold bg-amber-400 text-zinc-900 hover:bg-amber-300 transition">Bel
                            ons</a>
                        <a href="mailto:info@autohorsthuis.nl"
                           class="rounded-xl px-5 py-3 font-semibold bg-zinc-900 text-white hover:bg-zinc-800 transition">Mail
                            direct</a>
                        <a href="ms-outlook://compose?to=info@autohorsthuis.nl"
                           class="rounded-xl px-5 py-3 font-semibold bg-white/20 text-zinc-900 border border-zinc-300 hover:bg-white/40 transition">Open
                            in Outlook</a>
                    </div>
                </div>
