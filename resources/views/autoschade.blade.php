    ...
    <section class="py-4 px-6 lg:px-8 bg-zinc-50">
        <div class="mx-auto max-w-6xl grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <article class="group relative overflow-hidden rounded-2xl bg-black shadow-lg">
                <img src="{{ asset('images/autoschade/spotrepair.webp') }}" alt="Spot repair"
            ...
            <article class="group relative overflow-hidden rounded-2xl bg-black shadow-lg">
                <img src="{{ asset('images/autoschade/uitdeuken.webp') }}" alt="Uitdeuken zonder spuiten"
                     class="h-56 w-full object-cover transition duration-500 group-hover:scale-105" loading="lazy">
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div class="absolute inset-x-0 bottom-0 p-5 text-white">
            ...
            <article class="group relative overflow-hidden rounded-2xl bg-black shadow-lg">
                <img src="{{ asset('images/autoschade/ruitreparatie.webp') }}" alt="Ruitreparatie"
                     class="h-56 w-full object-cover transition duration-500 group-hover:scale-105" loading="lazy">
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div class="absolute inset-x-0 bottom-0 p-5 text-white">
            ...
            <article class="group relative overflow-hidden rounded-2xl bg-black shadow-lg">
                <img src="{{ asset('images/autoschade/aluminiumherstel.webp') }}" alt="Aluminium herstel"
                     class="h-56 w-full object-cover transition duration-500 group-hover:scale-105" loading="lazy">
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                <div class="absolute inset-x-0 bottom-0 p-5 text-white">
        ...
        <div class="mx-auto max-w-5xl">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div id="spot-repair" class="rounded-2xl border border-zinc-200 p-6 lg:p-8">
                    ...
                    <p class="mt-3 text-zinc-700">Kleine lakbeschadiging? <strong>Spot repair</strong> werkt efficiënt en
                        voordelig.</p>
                </div>
