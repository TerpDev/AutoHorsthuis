...
@section('content')
    <section class="relative min-h-[55vh] flex items-center justify-center bg-cover bg-center"
        ...
        <div class="relative z-10 mx-auto max-w-6xl px-6 lg:px-8 text-center text-white">
            ...
            <h1 class="mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-wide drop-shadow">Spuiterij & Fijnspuitwerk</h1>
        ...
        <div class="mx-auto max-w-5xl">
            <div class="prose prose-zinc">
                ...
                <p class="mt-3 text-zinc-700">
                    Auto Horsthuis in Oldenzaal is gespecialiseerd in alle soorten autoschades, <strong>fijnspuitwerk</strong> en
                    <strong>spotrepair</strong> van uw auto, motor of brommer. Ook voor het vakkundig repareren van deuken, krassen en parkeerschades.
                </p>
                <p class="mt-3 text-zinc-700">
                    Ook uw <strong>oldtimer</strong> is bij ons in goede handen. Met de juiste apparatuur en speciale lakken brengen wij uw klassieker weer in topconditie.
                </p>
                <p class="mt-3 text-zinc-700">
                    We werken in een ruime, goed ingerichte spuiterij en gebruiken de nieuwste <strong>watergedragen lakken</strong> voor een duurzaam en kleurvast resultaat.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 px-6 lg:px-8 bg-white">
        <div class="mx-auto max-w-5xl space-y-10">
            <article class="rounded-2xl border border-zinc-200 p-6 lg:p-8">
                ...
                <p class="mt-3 text-zinc-700">Moderne spuitcabines, kleurbepaling en mengsystemen voor resultaat dat naadloos aansluit bij de fabriekslak.</p>
            </article>
            <article class="rounded-2xl border border-amber-200 bg-amber-50 p-6 lg:p-8">
                ...
                <p class="mt-3 text-zinc-800">Brengt u vóór 09:00 uur uw voertuig voor kleine reparaties/spotrepair, dan is het vaak vóór 18:00 uur weer klaar (in overleg).</p>
            </article>
        </div>
    </section>

    <section class="relative py-14 bg-cover bg-center" style="background-image:url('{{ asset('images/spuiterij/spuiterij-cta.webp') }}');">
